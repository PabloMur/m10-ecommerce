...
export default function BigCard(props: BigCardType) {
  ...
  return (
    <div className="border border-gray-300 rounded overflow-hidden shadow-md mx-auto  my-8 w-[60%] flex justify-center">
      <div className="h-64 md:h-80 overflow-hidden w-1/2 bg-white flex justify-center items-center">
        <Image src={imageUrl} alt={title} width={220} height={100} />
      </div>
      <div className="flex flex-col w-1/2 bg-teal-50">
